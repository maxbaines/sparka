import { $isTextNode, type LexicalNode, type NodeKey, $getSelection, $isRangeSelection, $isElementNode } from 'lexical';
...
function findPositionsInEditor(editor: LexicalEditor, searchText: string): Position | null {
